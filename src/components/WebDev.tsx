  ...
  return (
    <div id='webdev-nav-scroll' className='webdev-container'>
      <div className='webdev-logos'>
        <img src="public/logos/webdev-logos.png" alt=""/>
      </div>
      <div className='webdev-section'>
        ...
        <p>It means I'm not showing up pretending to be a senior engineer—I'm here to play a solid junior role.</p>
...
function WebDev() {
  ...
  return (
    <div id='webdev-nav-scroll' className='webdev-container' ref={containerRef}>
      <div className='webdev-logos'>
        <img src="public/logos/webdev-logos.png" alt="" className={isVisible ? 'fade-in-1' : ''}/>
      </div>
      <div className={`webdev-section ${isVisible ? 'fade-in-2' : ''}`}>
        <h2>Did I mention I am a Junior Web Developer?</h2>
        <hr />
        <p>I'm like the utility player in software engineering—junior role, big hustle, and ready to contribute wherever needed.</p>
        <p>For the past year, I've been diving headfirst into full-stack development—HTML, CSS, JavaScript, React, Node, databases, the works.</p>
