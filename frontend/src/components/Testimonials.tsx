        ...
        <div className='testimonial-row'>
            ...
            <div className='testimonial-dailyhuman testimonial-card'>    
                <div className='headshot-info'>
                    ...
                    <p>Josh Roenitz</p>
                    <p>Founder & CEO</p>
                    <img className='testimonial-img-dailyhuman' src="public/logos/Dailyhuman-logo2.png" alt="" />
                </div>
        ...
        <div className='testimonial-row'>
            <div className='testimonial-lockeroom testimonial-card'>
                <div className='headshot-info'>
                    ...
                    <p>Co-Founder & CEO</p>
                    <img className='testimonial-img-lockeroom' src="public/logos/Lockeroom-Chat-logo.jfif" alt="" />
                </div>
            ...
            <div className='testimonial-k12 testimonial-card'>
                <div className='headshot-info'>
                    ...
                    <p>Abby Emerson</p>
                    <p>Founder</p>
                    <img className='testimonial-img-k12' src="public/logos/K12SportsTech-logo2.png" alt="" />
                </div>
        ...
        <div className='testimonial-row'>
            <div className='testimonial-sportective testimonial-card'>
                <div className='headshot-info'>
                    ...
                    <img className='testimonial-img-sportective' src="public/logos/SPORTECTIVE-LOGO.webp" alt="" />
                </div>
