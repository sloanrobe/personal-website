    ...
    <div className='testimonials'>
        ...
        <div className='testimonial-row'>
            <div className='testimonial-probility testimonial-card'>
                <div className='headshot-info'>
                    <img className='headshot-style' src="/headshots/plocki-headshot.jfif" alt="" />
                    <p>Doug Plocki</p>
                    <p>Founder & CEO</p>
                    <img className='testimonial-img-probility' src="/logos/ProbilityAI-logo.png" alt="" />
                </div>
            ...
            <div className='testimonial-dailyhuman testimonial-card'>    
                <div className='headshot-info'>
                    <img className='headshot-style' src="/headshots/josh-roenitz.jfif" alt="" />
                    <p>Josh Roenitz</p>
                    <p>Founder & CEO</p>
                    <img className='testimonial-img-dailyhuman' src="/logos/Dailyhuman-logo2.png" alt="" />
                </div>
        ...
        <div className='testimonial-row'>
            <div className='testimonial-lockeroom testimonial-card'>
                <div className='headshot-info'>
                    <img className='headshot-style' src="/headshots/demetri-harrison.jfif" alt="" />
                    <p>Demetri Harrison</p>
                    <p>Co-Founder & CEO</p>
                    <img className='testimonial-img-lockeroom' src="/logos/Lockeroom-Chat-logo.jfif" alt="" />
                </div>
            ...
            <div className='testimonial-k12 testimonial-card'>
                <div className='headshot-info'>
                    <img className='headshot-style' src="/headshots/abby-emerson.jfif" alt="" />
                    <p>Abby Emerson</p>
                    <p>Founder</p>
                    <img className='testimonial-img-k12' src="/logos/K12SportsTech-logo2.png" alt="" />
                </div>
        ...
        <div className='testimonial-row'>
            <div className='testimonial-sportective testimonial-card'>
                <div className='headshot-info'>
                    <img className='headshot-style' src="/headshots/neil-whitbread.jfif" alt="" />
                    <p>Neil Whitbread</p>
                    <p>Managing Director</p>
                    <img className='testimonial-img-sportective' src="/logos/SPORTECTIVE-LOGO.webp" alt="" />
                </div>
