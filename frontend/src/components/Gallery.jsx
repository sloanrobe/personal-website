...
const data = [
  ...
  { id: 3, imgSrc: Img3, alt: 'New York Jets at Miami Dolphins - Pregame photo of Benji on sideline' },
  { id: 4, imgSrc: Img19, alt: 'May 2025 - Speaking at `Elite Athletes Mindset for Startup Success` event in Barcelona' },
  { id: 5, imgSrc: Img15, alt: '1999 New York Jets team photo. Benji is on the front row, 4th from right.' },
  { id: 6, imgSrc: Img17, alt: 'May 2025 - Speaking at `Elite Athletes Mindset for Startup Success` event in Barcelona' },
  ...
  { id: 9, imgSrc: Img12, alt: 'January 2, 2000 - New York Jets vs. Seattle Seahawks' },
  { id: 10, imgSrc: Img11, alt: 'Photo with NFL Hall of Fame TE Tony Gonzalez' },
  ...
  { id: 14, imgSrc: Img1, alt: 'New York Jets at Miami Dolphins - Pregame photo of Benji on sideline' },
  { id: 15, imgSrc: Img16, alt: 'January 2, 2000 - New York Jets vs. Seattle Seahawks' },
  { id: 16, imgSrc: Img20, alt: 'May 2025 - Speaking at `Elite Athletes Mindset for Startup Success` event in Barcelona' },
  { id: 17, imgSrc: Img4, alt: 'September 12, 1999 - Benji with QB Vinny Testaverde, RB Richie Anderson, and Head Coach Bill Parcells' },
  { id: 18, imgSrc: Img2, alt: 'Benji on sideline during Jets at Dolphins pregame' },
  { id: 19, imgSrc: Img13, alt: 'January 2, 2000 - New York Jets vs. Seattle Seahawks' },
  { id: 20, imgSrc: Img18, alt: 'May 2025 - Speaking at `Elite Athletes Mindset for Startup Success` event in Barcelona' },
  { id: 21, imgSrc: Img14, alt: 'January 2, 2000 - New York Jets vs. Seattle Seahawks' },
];
